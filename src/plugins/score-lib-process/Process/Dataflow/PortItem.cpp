...
#define DRAW_ELLIPSE(Image, Pen, Brush, Ellipse)              \
  ...
  {                                                           \
    ...
    DRAW_ELLIPSE(
          SmallEllipsesInLight[4], geometrypen_light, nobrush, smallEllipse);
    DRAW_ELLIPSE(
    ...
    DRAW_ELLIPSE(
        LargeEllipsesInLight[4], geometrypen_light, nobrush, largeEllipse);
    DRAW_ELLIPSE(
